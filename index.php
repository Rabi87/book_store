    ...
    <div class="row mb-5 bg-light p-3 rounded-3 shadow-sm">
     ...
     <div class="row">
        ...
        <div class="col-12 mb-5">
            <h3 class="mb-4 text-primary"><i class="fas fa-book-open"></i> الكتب الفيزيائية</h3>
            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-6 justify-content-center">
                <?php while($book = $physical_books->fetch_assoc()): ?>
                <div class="col">
                    <div class="card h-100 shadow" style="min-height: 400px; max-height: 400px;width:200px;">
